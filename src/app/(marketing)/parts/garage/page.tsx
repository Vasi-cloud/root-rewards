...
export default function LeafyPartsGaragePage() {
  ...
  function handleRemove(id: string, partName: string) {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-4 py-8 pb-16 sm:px-6 sm:py-12">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-2 max-w-xl text-sm text-muted-foreground sm:text-base">
              Parts you&apos;ve saved from Leafy Parts Finder — ready to revisit
        ...
        <div className="mt-5 flex gap-3 rounded-2xl border border-emerald-200/80 bg-white/90 p-3.5 shadow-sm">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-0.5 text-sm leading-relaxed text-foreground">
              Your Garage stays on this browser for now. Still confirm fitment
              before you buy or install — especially for safety-critical parts.
            </p>
          </div>
        </div>
        ...
        {items.length === 0 ? (
          <div className="mt-4 rounded-3xl border border-dashed border-emerald-300/80 bg-emerald-50/40 px-4 py-12 text-center">
            ...
            <p className="mx-auto mt-1.5 max-w-sm text-sm text-muted-foreground">
              Identify a part in Leafy Parts Finder, then tap{" "}
