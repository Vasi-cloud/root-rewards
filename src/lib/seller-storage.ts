...
function buildDemoShops(): SellerProfile[] {
  return [
    ...
    {
      uid: "demo-lea-valley-cycle-hire",
      email: "hire@leavalleycycles.demo",
      shopName: "Lea Valley Cycle Hire",
      slug: "lea-valley-cycle-hire",
      sellerType: "individual",
      tradingName: "Lea Valley Cycle Hire",
      servicesOffered: "Rentals / hire, Garden & Outdoor",
      professionalBackground:
        "Local bike hire along the Lea Valley towpath — helmets and locks included.",
      bio: "Weekend and day hires for the Lea Valley trail — serviced hybrids and e-bikes, picked up locally.",
      ...
      products: [
        {
          ...
          description:
            "Comfortable hybrid for towpath and city legs. One-day hire with adjustable seat, front light, and D-lock. Collect near Lea Bridge — return by 8pm same day.",
          category: "Cycling",
          tags: ["hire", "cycling", "day rate", "lea valley"],
          price: 22,
          priceNote: "per day",
          hirePeriod: "1 day",
          ecoScore: 91,
          stock: 4,
          imageUrl: "/shop/tote.svg",
          gallery: ["/shop/tote.svg", "/shop/bottle.svg"],
          materials: "Hybrid frame · serviced weekly",
        ...
        },
        {
          ...
          description:
            "Weekend hire of a step-through e-bike with two battery levels, charger, and pannier. Ideal for longer Lea Valley loops. Return Monday evening.",
          category: "Outdoor",
          tags: ["hire", "e-bike", "weekend", "outdoor"],
          price: 68,
          priceNote: "per weekend",
          hirePeriod: "Fri–Mon weekend",
          ecoScore: 88,
          ...
          imageUrl: "/shop/bottle.svg",
          gallery: ["/shop/bottle.svg", "/shop/tote.svg", "/shop/pouch.svg"],
          materials: "E-bike · range ~40 miles",
          madeIn: "Lea Valley, UK",
