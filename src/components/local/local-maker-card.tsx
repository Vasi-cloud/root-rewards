...
import { ExternalLink, HeartHandshake, MapPin, Navigation } from "lucide-react";
        ...
        <div className="flex flex-wrap items-start justify-between gap-2">
          <div className="min-w-0 flex-1 space-y-1.5">
            <div className="flex flex-wrap items-center gap-1.5">
              {markerIndex != null && (
                <span className="flex size-6 items-center justify-center rounded-full bg-emerald-800 text-[11px] font-bold text-cream">
                  {markerIndex}
                </span>
              )}
              <Badge
